...
const WINNING_LINES = [
  // Rows
  [1, 2, 3], [2, 3, 4], [3, 4, 5], [ 6, 7, 8], [7, 8, 9], [8, 9, 10], [10, 11, 12],
  [12, 13, 14], [13, 14, 15], [16, 17, 18], [17, 18, 19], [18, 19, 20], [21, 22, 23],
  [22, 23, 24], [23, 24, 25],
  // Columns
  ...
  [8, 12, 16], [8, 14, 20], [9, 13, 17], [10, 14, 18], [11, 17, 23], [12, 18, 24], [13, 17, 21],
  [13, 19, 25], [14, 18, 22], [15, 19, 23],
];
...
function computerChoosesSquare(board, scores, currentPlayerMarker, opposition1, opposition2) {
  if (someoneWon(board)) {
    return 0;
  }
  ...
  for (let index = 0; index < WINNING_LINES.length; index += 1) {
    ...
    square = findAtRiskSquare(line, board, opposition1, opposition2);
    if (square) break;
  }
